        ...
        setItems([
          {
            ...
            execute: () => navigate({ to: '/services/new', search: { type: 'web' } }),
          },
          {
            label: 'Private service',
            description: 'Only exposed to your other services via the internal private network',
            keywords: ['create', 'deploy', 'service', 'private'],
            execute: () => navigate({ to: '/services/new', search: { type: 'private' } }),
          },
          {
            label: 'Worker',
            ...
            execute: () => navigate({ to: '/services/new', search: { type: 'worker' } }),
          },
          {
            label: 'Database',
